    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-one-paper-accepted-by-ieee-tmi-adaptive-conditional-contrast-agnostic-deformable-image-registration-with-uncertainty-estimation-link",
          title: 'One paper accepted by IEEE TMI: “Adaptive Conditional Contrast-Agnostic Deformable Image Registration with...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%78.%6C%75%6F@%69%6D%70%65%72%69%61%6C.%61%63.%75%6B", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/xzluo97", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/xinzhe-luo-50748b262", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-2822-1633", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=l-oyIaAAAAAJ", "_blank");
        },
      },{
        id: 'social-wechat_qr',
        title: 'Wechat_qr',
